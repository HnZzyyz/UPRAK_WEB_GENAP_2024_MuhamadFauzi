        ...
        <div class="card">
          <div class="card-body">
            <form action="post.php" method="post" class="row g-3 justify-content-center">
              <h3 style="text-align: center;">Input Data SPP</h3>
              ...
              <div class="row g-2 align-items-center">
                ...
                <div class="col-auto" style="width: 100%;">
                  <input type="text" name="tahun" class="form-control w-100">
                </div>
              </div>
              <div class="row g-2 align-items-center">
                <div class="col-auto">
                  <label for="input" class="col-form-label">Nominal</label>
                </div>
                <div class="col-auto" style="width: 100%;">
                  <input type="number" name="nominal" class="form-control w-100">
                </div>
              </div>
